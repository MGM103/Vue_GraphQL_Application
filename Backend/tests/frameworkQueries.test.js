...
describe("Test Framework Queries", () => {
  ...
  test("Test get framework by id", async () => {
    ...
    expect(result.data.getFrameworkById.competitors).toEqual(mockFramework.competitors);
    expect(result.data.getFrameworkById.naratives).toEqual(mockFramework.naratives);
    expect(result.data.getFrameworkById.bullcase).toEqual(mockFramework.bullcase);
    expect(result.data.getFrameworkById.bearcase).toEqual(mockFramework.bearcase);
    expect(result.data.getFrameworkById.acquisitionStrat).toEqual(mockFramework.acquisitionStrat);
    expect(result.data.getFrameworkById.exitConditions).toEqual(mockFramework.exitConditions);
